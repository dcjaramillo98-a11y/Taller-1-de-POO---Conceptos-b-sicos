...
// Se fija la cultura en invariante para que los separadores de miles de
// N0 siempre se impriman como coma (1,000), sin importar la configuración
// regional del equipo donde se ejecute (por ejemplo, es-CO).
